...
public class NewCumBiomeBiome extends BiomesOhPlantyModElements.ModElement {
	public static Biome biome;
	public NewCumBiomeBiome(BiomesOhPlantyModElements instance) {
		super(instance, 3);
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-1).setWaterColor(-52).setWaterFogColor(-13421824).withSkyColor(-1)
						...
						.setMusic(new BackgroundMusicSelector((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("block.enchantment_table.use")), 12000, 24000, true))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("biomes_oh_planty:new_cum_biome"));
			}
		}
	}
	@Override
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("new_cum_biome_ctd");
