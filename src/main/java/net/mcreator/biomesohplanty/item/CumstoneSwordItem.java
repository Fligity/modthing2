...
public class CumstoneSwordItem extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cumstone_sword")
	public static final Item block = null;
	public CumstoneSwordItem(BiomesOhPlantyModElements instance) {
		super(instance, 127);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("cumstone_sword"));
	}
}
