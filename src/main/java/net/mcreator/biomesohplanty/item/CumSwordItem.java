...
public class CumSwordItem extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cum_sword")
	public static final Item block = null;
	public CumSwordItem(BiomesOhPlantyModElements instance) {
		super(instance, 31);
	}
