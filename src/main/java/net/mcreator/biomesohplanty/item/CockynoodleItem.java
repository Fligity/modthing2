...
public class CockynoodleItem extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cockynoodle")
	public static final Item block = null;
	public CockynoodleItem(BiomesOhPlantyModElements instance) {
		super(instance, 48);
	}
