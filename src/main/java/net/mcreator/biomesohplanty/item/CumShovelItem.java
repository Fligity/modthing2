...
public class CumShovelItem extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cum_shovel")
	public static final Item block = null;
	public CumShovelItem(BiomesOhPlantyModElements instance) {
		super(instance, 32);
	}
