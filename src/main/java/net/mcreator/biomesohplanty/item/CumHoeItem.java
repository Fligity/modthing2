...
public class CumHoeItem extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cum_hoe")
	public static final Item block = null;
	public CumHoeItem(BiomesOhPlantyModElements instance) {
		super(instance, 33);
	}
