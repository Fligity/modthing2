...
public class CumstoneAxeItem extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cumstone_axe")
	public static final Item block = null;
	public CumstoneAxeItem(BiomesOhPlantyModElements instance) {
		super(instance, 126);
	}
