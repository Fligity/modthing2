...
public class HolyPeniswoodFenceGateBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_fence_gate")
	public static final Block block = null;
	public HolyPeniswoodFenceGateBlock(BiomesOhPlantyModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_fence_gate");
		}
