...
public class BlockofcumBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:blockofcum")
	public static final Block block = null;
	public BlockofcumBlock(BiomesOhPlantyModElements instance) {
		super(instance, 39);
