...
public class HolyPeniswoodButtonBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_button")
	public static final Block block = null;
	public HolyPeniswoodButtonBlock(BiomesOhPlantyModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_button");
		}
