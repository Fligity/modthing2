...
public class HolyPeniswoodSlabBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_slab")
	public static final Block block = null;
	public HolyPeniswoodSlabBlock(BiomesOhPlantyModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_slab");
		}
