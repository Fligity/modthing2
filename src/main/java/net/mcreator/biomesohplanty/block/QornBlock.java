...
import net.mcreator.biomesohplanty.item.QorncobItem;
...
public class QornBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:qorn")
	public static final Block block = null;
	public QornBlock(BiomesOhPlantyModElements instance) {
		super(instance, 117);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("qorn"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("biomes_oh_planty:qorn"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("biomes_oh_planty:grey_cum_biome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(QorncobItem.block, (int) (2)));
		}
