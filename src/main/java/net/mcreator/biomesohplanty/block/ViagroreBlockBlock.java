...
public class ViagroreBlockBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:viagrore_block")
	public static final Block block = null;
	public ViagroreBlockBlock(BiomesOhPlantyModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("viagrore_block");
		}
