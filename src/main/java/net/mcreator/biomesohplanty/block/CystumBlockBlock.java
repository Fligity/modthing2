...
public class CystumBlockBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cystum_block")
	public static final Block block = null;
	public CystumBlockBlock(BiomesOhPlantyModElements instance) {
		super(instance, 107);
	}
