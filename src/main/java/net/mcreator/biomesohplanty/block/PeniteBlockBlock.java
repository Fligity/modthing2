...
public class PeniteBlockBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:penite_block")
	public static final Block block = null;
	public PeniteBlockBlock(BiomesOhPlantyModElements instance) {
		super(instance, 81);
	}
