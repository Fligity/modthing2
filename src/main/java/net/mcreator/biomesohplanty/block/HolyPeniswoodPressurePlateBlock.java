...
public class HolyPeniswoodPressurePlateBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_pressure_plate")
	public static final Block block = null;
	public HolyPeniswoodPressurePlateBlock(BiomesOhPlantyModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_pressure_plate");
		}
