...
public class CumzoneStoneBrickStairsBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:cumzone_stone_brick_stairs")
	public static final Block block = null;
	public CumzoneStoneBrickStairsBlock(BiomesOhPlantyModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cumzone_stone_brick_stairs");
		}
