...
public class HolyPeniswoodLeavesBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_leaves")
	public static final Block block = null;
	public HolyPeniswoodLeavesBlock(BiomesOhPlantyModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_leaves");
		}
