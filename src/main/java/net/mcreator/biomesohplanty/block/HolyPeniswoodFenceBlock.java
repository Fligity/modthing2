...
public class HolyPeniswoodFenceBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_fence")
	public static final Block block = null;
	public HolyPeniswoodFenceBlock(BiomesOhPlantyModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_fence");
		}
