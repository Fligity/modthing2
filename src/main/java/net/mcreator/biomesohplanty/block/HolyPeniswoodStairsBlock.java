...
public class HolyPeniswoodStairsBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_stairs")
	public static final Block block = null;
	public HolyPeniswoodStairsBlock(BiomesOhPlantyModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_stairs");
		}
