...
public class HolyPeniswoodPlanksBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_planks")
	public static final Block block = null;
	public HolyPeniswoodPlanksBlock(BiomesOhPlantyModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_planks");
		}
