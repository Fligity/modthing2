...
public class HolyPeniswoodWoodBlock extends BiomesOhPlantyModElements.ModElement {
	@ObjectHolder("biomes_oh_planty:holy_peniswood_wood")
	public static final Block block = null;
	public HolyPeniswoodWoodBlock(BiomesOhPlantyModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("holy_peniswood_wood");
		}
