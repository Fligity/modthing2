...
import net.mcreator.biomesohplanty.entity.SpectercumEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class SpectercumRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SpectercumEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSpectercum(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("biomes_oh_planty:textures/spectercum.png");
					}
				};
			});
		}
